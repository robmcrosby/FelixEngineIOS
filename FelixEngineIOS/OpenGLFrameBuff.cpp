...
void OpenGLFrameBuff::clear(Color color) const {
  // Set this as the active FBO.
  use();
  
  // Set to draw to the depth buffer.
...
void OpenGLFrameBuff::setDrawType(DRAW_TYPE type) const {
